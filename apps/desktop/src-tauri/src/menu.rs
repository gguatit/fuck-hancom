...
pub fn install(app: &mut App) -> tauri::Result<()> {
    let app_about = MenuItemBuilder::with_id("file:about", "About Fuck Hancom").build(app)?;
    let app_quit = MenuItemBuilder::with_id("app:quit", "Quit Fuck Hancom")
    ...
    #[cfg(target_os = "macos")]
    let app_menu = SubmenuBuilder::new(app, "Fuck Hancom")
        .item(&app_about)
        .separator()
        .services()
        .separator()
